...
const CANDIDATES = [
  ...
  { id: "akesson",            name: "Jimmie Åkesson",            party: "SD", role: "Partiledare",
    quote: { text: "Muslimerna är vårt största utländska hot sedan andra världskriget.", source: "Sveriges Radio", url: "https://www.sverigesradio.se/artikel/3178213" } },
  ...
  { id: "kronlid",            name: "Julia Kronlid",             party: "SD", role: "Andre vice talman",
  ...
  { id: "soder_bjorn",        name: "Björn Söder",               party: "SD", role: "Riksdagsledamot",
    quote: { text: "Annie Lööf förringar judars och samers ställning i Sverige när hon indirekt hävdar att de är svenskar. Dessa grupper har minoritetsställning i Sverige just för att de inte är svenskar.", source: "SVT", url: "https://www.svt.se/nyheter/inrikes/politiker-i-natbrak-om-minoriteters-svenskhet" } },
  ...
  { id: "broman",             name: "Bo Broman",                 party: "SD", role: "Partikassör" },
