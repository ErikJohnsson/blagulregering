...
const CANDIDATES = [
  ...
  { id: "aspling",            name: "Ludvig Aspling",            party: "SD", role: "Utrikes- och EU-politik",
    quote: { text: "Vi har alldeles för många som inte är en del av den etniskt svenska befolkningen.", source: "Dagens ETC", url: "https://www.etc.se/inrikes/aspling-sd-efter-utspelet-saa-laangt-aer-sd-beredda-att-gaa" } },
