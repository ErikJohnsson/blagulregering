...
const CANDIDATES = [
  ...
  { id: "lindberg",           name: "Linda Lindberg",            party: "SD", role: "Vice partiledare",
    quote: { text: "Queer är ett begrepp där extremiteter som pedofili och nekrofili ingår.", source: "Lokaltidningen, 2016", url: "https://aktuelltfokus.se/sd-politiker-jamfor-queerpersoner-med-nekrofiler/" } },
  ...
  { id: "kronlid",            name: "Julia Kronlid",             party: "SD", role: "Riksdagens vice talman",
    quote: { text: "Jag accepterar inte att människan härstammar från apor.", source: "Sans, 2014", url: "https://www.etc.se/inrikes/det-haer-aer-julia-kronlid-abortkritik-och-evolutionsfoernekelse" } },
  ...
  { id: "broman",             name: "Bo Broman",                 party: "SD", role: "Kulturpolitisk talesperson",
    quote: { text: "Prideflaggan har blivit ett varumärke för en politiserad aktör som hånar och förlöjligar människor med andra politiska åsikter.", source: "QX, 2019", url: "https://www.qx.se/samhalle/191494/sd-sagar-prideflaggan-inte-langre-inkluderande/" } },
  ...
  { id: "aspling",            name: "Ludvig Aspling",            party: "SD", role: "Utrikes- och EU-politik",
    quote: { text: "Sverige har alldeles för många som inte tillhör den etniskt svenska befolkningen.", source: "Dagens ETC", url: "https://kvartal.se/nyheter/artiklar/sd-spricka-efter-asplings-ord-om-etniska-svenskar/cG9zdDoxNTEyMDg" } },
